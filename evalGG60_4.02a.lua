...
cmd:text('Options:')
cmd:option('--xpPath', '/home/ryan/save/ubuntu:1461118938:1.dat', 'path to a previously saved model')
...
input = inputs:narrow(1,1,50)
target =  targets:narrow(1,1,50)
...
if input:size(3) == 100 then
  ...
  glanceNetwork = torch.load('mnistConv60_Relu.net').module
end
